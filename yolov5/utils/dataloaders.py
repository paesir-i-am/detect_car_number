...
class LoadImages:
    ...
    def _new_video(self, path):
        ...
        # !수정 --------------------------------------------------
        print('utils/dataloaders.py  rotation degrees: ',self.orientation);
        # 동영상 메타 정보에서 90도 라고 나오는 동영상이
        # cv2 rotation degrees 가 270으로 나오고
        # 결과물이 180도 위아래가 회전 되서 나온다
        # -> _cv2_rotate() 호출하여 180도 회전 해줌
        # --------------------------------------------------------
